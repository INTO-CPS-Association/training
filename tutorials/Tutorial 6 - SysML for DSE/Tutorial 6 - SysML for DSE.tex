...
\item On the left hand side of the editor window, select `INTO-CPS \menusep ExternalScript' to show INTO-CPS DSE properties. Change \{\}file to `$meanspeed.py$', and close the editor window.
