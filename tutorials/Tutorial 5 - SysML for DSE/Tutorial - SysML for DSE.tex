...
\item Set the \emph{Workspace} to the location of \emph{Tutorials\pathsep{}Tutorial\_5\pathsep{}SysML} and click \emph{Ok}.

\begin{center}
\begin{annotation}[width=0.5\linewidth,trim=0 0 0 0,clip]{figures/modelio_workspace_choice}
    \upoint{0.15}{Path to \emph{Tutorials\pathsep{}Tutorial\_5\pathsep{}SysML}}{0.27,0.42}
